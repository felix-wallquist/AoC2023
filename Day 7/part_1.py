...
def hand_type(hand):
    ...
    if len(set(hand)) == 2:
        if len(re.findall(r''+list(set(hand))[0]+'', hand)) == 4 or len(re.findall(r''+list(set(hand))[0]+'', hand)) == 1:
            # Four-of-a-kind
            return 5
        # Full house
        return 4
    ...
    if len(set(hand)) == 3:
        if len(re.findall(r''+list(set(hand))[0]+'', hand)) == 3 or len(re.findall(r''+list(set(hand))[1]+'', hand)) == 3 or len(re.findall(r''+list(set(hand))[2]+'', hand)) == 3:
            # Three-of-a-kind
            return 3
        # Two pair
        return 2
